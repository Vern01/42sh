...
/*   Updated: 2016/07/28 17:24:13 by rojones          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_sh21.h"

static int	ft_redir_out(char **args, int op)
{
	int     fd;
	int     sfd;
	int     s;
...
static int	ft_redir_in(char **args, int op)
{
	int     fd;
	int     sfd;
	int     s;
